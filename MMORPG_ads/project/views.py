...
from project.utils.db import counterparties_sql as cp
from project.utils.db.counterparties_sql import cn

# class Home(View):
#
#     def get(self, request, *args, **kwargs):
#         f = open(r'core/templates/flatpages/default.html', 'r')
#         pattern = f.read()
#         f.close()
